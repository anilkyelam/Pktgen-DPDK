...
static const char *set_help[] = {
    ...
    "set <portlist> pktcfg add <macaddr> <weight>	- Add a pkt config entry",
    "set <portlist> pktcfg reset	- Remove all saved pkt config entries",
...
set_cmd(int argc, char **argv)
{
    ...
    switch(m->index) {
        ...
        case 110:
            u1 = strtol(argv[5], NULL, 0);
            foreach_port(portlist, single_add_pktcfg(info, pg_ether_aton(argv[4], NULL), u1));
            break;
        case 120:
...
static const char *enable_help[] = {
    ...
    "enable|disable <portlist> pktcfg	- Enable/Disable pkt config on given ports",
        ...
        case 20:
            ...
            switch(n) {
                ...
                case 18:
                    ...
                    break;
                case 19:
                    foreach_port(portlist, enable_pktcfg(info, state));
                    break;
                default:
                    return cli_cmd_error("Enable/Disable invalid command", "Enable", argc, argv);
            }
