...
void pktgen_pktcfg_apply(port_info_t *info, struct rte_mbuf **pkts, size_t cnt, int32_t seq_idx);
void pktgen_recv_pktcfg(port_info_t *info, struct rte_mbuf **pkts, size_t cnt);
