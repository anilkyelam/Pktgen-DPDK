...
int pktgen_port_pktcfg_stats(int port, eth_stats_t *pstats);
...
void single_add_pktcfg(port_info_t *info, struct pg_ether_addr *mac, uint32_t weight);
void single_reset_pktcfg(port_info_t *info);
...
void enable_pktcfg(port_info_t *info, uint32_t state);
